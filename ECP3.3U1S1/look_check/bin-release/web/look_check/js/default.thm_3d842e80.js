	...
	function LetsPlaySkin() {
		_super.call(this);
		this.skinParts = ["kGrpSheepIdle","kGrpSheepCatch","kGrpSheepJump","kGrpSheep","kImgMask","kImgHint","kImgOption0","kGrpOption0","kImgOption1","kGrpOption1","kImgOption2","kGrpOption2","kImgOption3","kGrpOption3","kGrpGame","kComRestart","kLabelHint","kComBar","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.x = 240;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this.kGrpSheep_i(),this.kImgMask_i(),this.kImgHint_i(),this._Group1_i(),this.kGrpGame_i(),this.kComRestart_i(),this.kLabelHint_i(),this.kComBar_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.y = 116;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this.kGrpOption0_i(),this.kGrpOption1_i(),this.kGrpOption2_i(),this.kGrpOption3_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
	...
	_proto.kImgOption0_i = function () {
		var t = new eui.Image();
		this.kImgOption0 = t;
		t.anchorOffsetX = 326.5;
		t.anchorOffsetY = 326.5;
	...
	_proto.kGrpOption2_i = function () {
		...
		t.x = 20;
		t.y = 20;
		t.elementsContent = [this.kImgOption2_i()];
		return t;
	};
	...
	_proto.kGrpOption3_i = function () {
		...
		t.x = 30;
		t.y = 30;
		t.elementsContent = [this.kImgOption3_i()];
		return t;
	};
	...
	return LetsPlaySkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/play/LookCheckPreComSkin.exml'] = window.LookCheckPreComSkin = (function (_super) {
	__extends(LookCheckPreComSkin, _super);
	function LookCheckPreComSkin() {
		_super.call(this);
		this.skinParts = ["kImg","kLabel0","kImgCheck0","kGrp0","kImgCheck1","kLabel1","kGrp1","kGrpAnim","kImgLine"];
		
		this.height = 420;
		this.width = 1600;
		this.elementsContent = [this.kImg_i(),this.kGrp0_i(),this.kGrp1_i(),this.kGrpAnim_i(),this.kImgLine_i()];
	}
	var _proto = LookCheckPreComSkin.prototype;

	_proto.kImg_i = function () {
		var t = new eui.Image();
		this.kImg = t;
		t.horizontalCenter = 0;
		t.source = "img_lc_panel_1_png";
		t.verticalCenter = 0;
		return t;
	};
	_proto.kGrp0_i = function () {
		...
		t.x = 604.82;
		t.y = 76.21;
		t.elementsContent = [this.kLabel0_i(),this.kImgCheck0_i()];
		return t;
	};
	_proto.kLabel0_i = function () {
		...
		t.bold = true;
		t.size = 55;
		t.text = "I always go sledding.";
		t.textColor = 0x000000;
		t.x = 147.74;
		t.y = 30.5;
		return t;
	};
	_proto.kImgCheck0_i = function () {
		var t = new eui.Image();
		this.kImgCheck0 = t;
		t.source = "img_lc_check_png";
		t.x = 0;
		t.y = -17;
		return t;
	};
	_proto.kGrp1_i = function () {
		...
		t.x = 607.56;
		t.y = 213.64;
		t.elementsContent = [this.kImgCheck1_i(),this.kLabel1_i()];
		return t;
	};
	_proto.kImgCheck1_i = function () {
		var t = new eui.Image();
		this.kImgCheck1 = t;
		t.source = "img_lc_check_png";
		t.x = 0;
	...
	_proto.kImgLine_i = function () {
		var t = new eui.Image();
		this.kImgLine = t;
		t.horizontalCenter = 0;
		t.source = "img_lc_frame_png";
		t.touchEnabled = false;
		t.verticalCenter = 0;
		return t;
	};
	return LookCheckPreComSkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/play/LookCheckViewSkin.exml'] = window.LookCheckViewSkin = (function (_super) {
	__extends(LookCheckViewSkin, _super);
	function LookCheckViewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpCom","kComReplay","kComAnswer"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this.kGrpCom_i(),this.kComReplay_i(),this.kComAnswer_i()];
	}
	var _proto = LookCheckViewSkin.prototype;
