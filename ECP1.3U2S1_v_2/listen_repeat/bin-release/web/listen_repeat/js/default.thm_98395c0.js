	...
	function VideoComponentSkin() {
		_super.call(this);
		this.skinParts = ["kGrpVideo","kRect","kComPro","kImgMaskPrePlay"];
		
		this.height = 542;
		this.width = 720;
		this.elementsContent = [this.kGrpVideo_i(),this.kRect_i(),this.kComPro_i(),this.kImgMaskPrePlay_i()];
	}
	...
	_proto.kImgMaskPrePlay_i = function () {
		var t = new eui.Image();
		this.kImgMaskPrePlay = t;
		t.height = 542;
		t.horizontalCenter = 0;
		t.source = "img_listenVideo_mask_png";
		t.verticalCenter = 0;
		t.width = 720;
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.horizontalCenter = 0;
		t.verticalCenter = 0;
		t.elementsContent = [this._Rect1_i(),this.klbl_i()];
		return t;
	};
	...
	function ListenRepeatViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kComVideo","kCom0","kCom1","kCom2","kCom3","kCom4","kGp","kImgBtnNext","kImgBtnPre"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.kImgBg_i(),this._Group2_i(),this.kImgBtnNext_i(),this.kImgBtnPre_i()];
	}
	...
	_proto._Group2_i = function () {
		...
		t.elementsContent = [this._Group1_i(),this.kGp_i()];
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.x = 243;
		t.y = 0;
		t.elementsContent = [this.kComVideo_i(),this._Image1_i()];
		return t;
	};
	_proto.kComVideo_i = function () {
	...
	_proto.kGp_i = function () {
		...
		t.elementsContent = [this.kCom0_i(),this.kCom1_i(),this.kCom2_i(),this.kCom3_i(),this.kCom4_i()];
		return t;
	};
