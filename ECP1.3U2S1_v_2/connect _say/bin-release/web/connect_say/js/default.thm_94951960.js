                ...
                generateEUI.skins = {"ItembkSkin":"resource/eui_skins/component/itembkSkin.exml","ItembkSkin1":"resource/eui_skins/component/itembkSkin1.exml","Box":"resource/eui_skins/component/Box.exml","game.StickSay":"resource/eui_skins/StickSay.exml","game.BtnSelect":"resource/eui_skins/BtnSelect.exml","game.ConnectSayView":"resource/eui_skins/ConnectSayView.exml"};generateEUI.paths['resource/eui_skins/BtnSelect.exml'] = window.BtnSelectSkin = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/ConnectSayView.exml'] = window.ConnectSayViewSkin = (function (_super) {
	__extends(ConnectSayViewSkin, _super);
	function ConnectSayViewSkin() {
		_super.call(this);
		this.skinParts = ["kRect1","kLeft1","kRect2","kLeft2","kLeft","kGirlLine1","kGirlLine2","kGirlLine3","kBoyLine1","kBoyLine2","kBoyLine3","kBoyLine4","kBoyLine5","k10_1","kTips1","k10","kSnow","kSnowGp","kTips2","k19","kRight","kReplay","kAnswer"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Group1_i(),this.kReplay_i(),this.kAnswer_i()];
	}
	var _proto = ConnectSayViewSkin.prototype;
	...
	_proto._Group1_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1440;
		t.elementsContent = [this._Image2_i(),this.kLeft_i(),this.kRight_i(),this._Image22_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.kLeft_i = function () {
		var t = new eui.Group();
		this.kLeft = t;
		t.left = 15;
		t.verticalCenter = 0;
		t.elementsContent = [this._Image3_i(),this.kLeft1_i(),this.kLeft2_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
		t.horizontalCenter = 0;
		t.scale9Grid = new egret.Rectangle(26,40,161,240);
		t.scaleX = 2;
		t.scaleY = 2.2;
		t.source = "connect_10_png";
		t.verticalCenter = 0;
		return t;
	};
	_proto.kLeft1_i = function () {
		var t = new eui.Group();
		this.kLeft1 = t;
		t.height = 266;
		t.horizontalCenter = 0;
		t.width = 370;
		t.y = 62;
		t.elementsContent = [this.kRect1_i(),this._Image4_i()];
		return t;
	};
	_proto.kRect1_i = function () {
		var t = new eui.Rect();
		this.kRect1 = t;
		t.anchorOffsetX = 185;
		t.anchorOffsetY = 133;
	...
	_proto._Image4_i = function () {
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "connect_2_png";
		t.verticalCenter = 0;
		return t;
	};
	_proto.kLeft2_i = function () {
		var t = new eui.Group();
		this.kLeft2 = t;
		t.height = 266;
		t.horizontalCenter = 0;
		t.width = 366;
		t.y = 380;
		t.elementsContent = [this.kRect2_i(),this._Image5_i()];
		return t;
	};
	_proto.kRect2_i = function () {
		var t = new eui.Rect();
		this.kRect2 = t;
		t.anchorOffsetX = 185;
		t.anchorOffsetY = 133;
	...
	_proto._Image5_i = function () {
		...
		t.scaleX = 0.99;
		t.scaleY = 1.01;
		t.source = "connect_9_png";
		t.verticalCenter = 3.5;
		return t;
	};
	_proto.kRight_i = function () {
		var t = new eui.Group();
		this.kRight = t;
		t.height = 1018;
		t.right = 27;
		t.verticalCenter = 0;
		t.width = 970;
		t.elementsContent = [this._Image6_i(),this.k10_i(),this.k19_i()];
		return t;
	};
	_proto._Image6_i = function () {
		var t = new eui.Image();
		t.right = -33;
		t.scale9Grid = new egret.Rectangle(71,87,428,528);
		t.scaleX = 1.7;
		t.scaleY = 1.455;
		t.source = "connect_11_png";
		t.verticalCenter = 11.5;
		t.x = -13;
		t.y = -5;
		return t;
	};
	_proto.k10_i = function () {
		var t = new eui.Group();
		this.k10 = t;
		t.bottom = 0;
		t.left = 9;
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this._Image7_i(),this.k10_1_i(),this._Image10_i(),this._Image11_i(),this.kTips1_i()];
		return t;
	};
	...
	_proto.k10_1_i = function () {
		...
		t.x = 21;
		t.y = 215;
		t.elementsContent = [this._Image8_i(),this._Image9_i(),this.kGirlLine1_i(),this.kGirlLine2_i(),this.kGirlLine3_i(),this.kBoyLine1_i(),this.kBoyLine2_i(),this.kBoyLine3_i(),this.kBoyLine4_i(),this.kBoyLine5_i()];
		return t;
	};
	...
	_proto._Image11_i = function () {
		...
		t.scaleX = 2.5;
		t.scaleY = 2.5;
		t.source = "connect_1_png";
		t.top = 32;
		return t;
	};
	_proto.kTips1_i = function () {
		var t = new eui.Image();
		this.kTips1 = t;
		t.horizontalCenter = -1.5;
		t.scaleX = 1.5;
		t.scaleY = 1.5;
		t.source = "connect_5_png";
		t.visible = false;
		t.y = 833.24;
		return t;
	};
	_proto.k19_i = function () {
		var t = new eui.Group();
		this.k19 = t;
		t.height = 1018;
		t.visible = false;
		...
		t.x = 9.09;
		t.y = 0;
		t.elementsContent = [this._Image12_i(),this.kSnow_i(),this._Image13_i(),this.kSnowGp_i(),this._Image21_i(),this.kTips2_i()];
		return t;
	};
	...
	_proto.kSnow_i = function () {
		var t = new eui.Image();
		this.kSnow = t;
		t.scaleX = 1.8;
		t.scaleY = 2;
		t.source = "connect_12_png";
		t.visible = false;
		t.x = 125.71;
		t.y = 218.99;
		return t;
	...
	_proto._Image13_i = function () {
		...
		t.scaleX = 2.5;
		t.scaleY = 2.5;
		t.source = "connect_4_png";
		t.top = 24;
		return t;
	};
	_proto.kSnowGp_i = function () {
		var t = new eui.Group();
		this.kSnowGp = t;
		t.height = 500;
		t.width = 300;
		t.x = 207.68;
		t.y = 289.02;
		t.elementsContent = [this._Image14_i(),this._Image15_i(),this._Image16_i(),this._Image17_i(),this._Image18_i(),this._Image19_i(),this._Image20_i()];
		return t;
	};
	_proto._Image14_i = function () {
		...
		t.scaleY = 2;
		t.source = "1_png";
		t.x = -79.68000000000006;
		t.y = -68.01999999999998;
		return t;
	};
	_proto._Image15_i = function () {
		...
		t.source = "snow_1_png";
		t.visible = false;
		t.x = 151.32000000000005;
		t.y = 18.980000000000018;
		return t;
	};
	_proto._Image16_i = function () {
		...
		t.source = "snow_2_png";
		t.visible = false;
		t.x = 208.32000000000005;
		t.y = 71.98000000000002;
		return t;
	};
	_proto._Image17_i = function () {
		...
		t.source = "snow_3_png";
		t.visible = false;
		t.x = 175.32000000000005;
		t.y = 155.98000000000002;
		return t;
	};
	_proto._Image18_i = function () {
		...
		t.source = "snow_4_png";
		t.visible = false;
		t.x = 219.32000000000005;
		t.y = 208.98000000000002;
		return t;
	};
	...
	_proto.kTips2_i = function () {
		var t = new eui.Image();
		this.kTips2 = t;
		t.horizontalCenter = 0;
		t.scaleX = 1.5;
		t.scaleY = 1.5;
		t.source = "connect_13_png";
		t.visible = false;
		t.y = 831.24;
		return t;
	};
