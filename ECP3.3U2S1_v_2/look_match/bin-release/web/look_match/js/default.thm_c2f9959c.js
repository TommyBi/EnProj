	...
	return LetsPlaySkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/play/LookMatchViewSkin.exml'] = window.LookMatchViewSkin = (function (_super) {
	__extends(LookMatchViewSkin, _super);
	function LookMatchViewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpStart0","kImgMask0","kGrpRole0","kGrpStart1","kImgMask1","kGrpRole1","kGrpStart2","kImgMask2","kGrpRole2","kGrpTar0","kGrpTar1","kGrpTar2","kImgPen0","kGrpPen0","kImgPen1","kGrpPen1","kImgPen2","kGrpPen2","kImgPen3","kGrpPen3","kImgArrow2","kImgArrow0","kImgArrow1","kImgArrowStatic2","kImgArrowStatic0","kImgArrowStatic1","kImgPen","kComReplay","kComAnswer"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.kGrpStart0_i(),this._Group1_i(),this.kGrpStart1_i(),this._Group2_i(),this.kGrpStart2_i(),this._Group3_i(),this.kGrpTar0_i(),this.kGrpTar1_i(),this.kGrpTar2_i(),this._Group4_i(),this._Group5_i(),this._Group6_i(),this._Image18_i(),this._Group7_i(),this.kImgArrow2_i(),this.kImgArrow0_i(),this.kImgArrow1_i(),this.kImgArrowStatic2_i(),this.kImgArrowStatic0_i(),this.kImgArrowStatic1_i(),this.kImgPen_i(),this.kComReplay_i(),this.kComAnswer_i()];
	}
	var _proto = LookMatchViewSkin.prototype;
	...
	_proto._Image2_i = function () {
		...
		t.height = 1488.69;
		t.horizontalCenter = 0;
		t.source = "img_lm_bg_png";
		t.verticalCenter = 0;
		t.width = 1491.66;
		return t;
	};
	_proto.kGrpStart0_i = function () {
		var t = new eui.Group();
		this.kGrpStart0 = t;
		t.height = 100;
		t.touchChildren = false;
	...
	_proto._Group1_i = function () {
		...
		t.x = 245.64;
		t.y = 52.24;
		t.elementsContent = [this._Image4_i(),this.kImgMask0_i(),this._Image5_i(),this.kGrpRole0_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
		t.source = "img_lm_option0_png";
		t.x = 28;
		t.y = 4;
		return t;
	};
	...
	_proto._Image5_i = function () {
		var t = new eui.Image();
		t.source = "img_lm_num0_png";
		t.x = 0;
		t.y = -21.21;
		return t;
	};
	_proto.kGrpRole0_i = function () {
		var t = new eui.Group();
		this.kGrpRole0 = t;
		t.height = 100;
		t.width = 100;
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0.5;
		t.x = 248.67;
		t.elementsContent = [this._Image7_i(),this.kImgMask1_i(),this._Image8_i(),this.kGrpRole1_i()];
		return t;
	};
	_proto._Image7_i = function () {
		var t = new eui.Image();
		t.source = "img_lm_option1_png";
		t.x = 26;
		t.y = 4;
		return t;
	};
	...
	_proto._Image8_i = function () {
		var t = new eui.Image();
		t.source = "img_lm_num1_png";
		t.x = 0;
		t.y = -12.12;
		return t;
	};
	_proto.kGrpRole1_i = function () {
		var t = new eui.Group();
		this.kGrpRole1 = t;
		t.height = 100;
		t.width = 100;
	...
	_proto._Group3_i = function () {
		...
		t.verticalCenter = 364;
		t.x = 248;
		t.elementsContent = [this._Image10_i(),this.kImgMask2_i(),this.kGrpRole2_i(),this._Image11_i()];
		return t;
	};
	_proto._Image10_i = function () {
		var t = new eui.Image();
		t.source = "img_lm_option2_png";
		t.x = 26;
		t.y = 4;
		return t;
	};
	...
	_proto._Group4_i = function () {
		...
		t.x = 875;
		t.y = 77.21;
		t.elementsContent = [this._Image15_i(),this._Label1_i()];
		return t;
	};
	_proto._Image15_i = function () {
		var t = new eui.Image();
	...
	_proto._Label1_i = function () {
		...
		t.size = 50;
		t.text = "Cactuses keep water in their bodies";
		t.textColor = 0x000000;
		t.verticalCenter = 3;
		t.width = 512.11;
		return t;
	...
	_proto._Label2_i = function () {
		...
		t.size = 50;
		t.text = "Camels keep water in ther bodies.";
		t.textColor = 0x000000;
		t.verticalCenter = 0.5;
		t.width = 475.46;
		return t;
	...
	_proto._Group6_i = function () {
		...
		t.x = 875;
		t.elementsContent = [this._Image17_i(),this._Label3_i()];
		return t;
	};
	_proto._Image17_i = function () {
		var t = new eui.Image();
	...
	_proto._Group7_i = function () {
		...
		t.elementsContent = [this.kGrpPen0_i(),this.kGrpPen1_i(),this.kGrpPen2_i(),this.kGrpPen3_i()];
		return t;
	};
	...
	_proto.kGrpPen0_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image19_i(),this.kImgPen0_i()];
		return t;
	};
	_proto._Image19_i = function () {
		var t = new eui.Image();
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_lm_pencil_bg_png";
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.kImgPen0_i = function () {
		var t = new eui.Image();
		this.kImgPen0 = t;
		t.scaleX = 0.4;
		t.scaleY = 0.4;
		t.source = "img_lm_pencil_0_png";
		t.touchEnabled = false;
		t.x = 28;
		t.y = 40;
		return t;
	};
	_proto.kGrpPen1_i = function () {
		var t = new eui.Group();
		this.kGrpPen1 = t;
		t.touchChildren = false;
		t.touchEnabled = true;
		...
		t.x = 10;
		t.y = 10;
		t.elementsContent = [this._Image20_i(),this.kImgPen1_i()];
		return t;
	};
	_proto._Image20_i = function () {
		var t = new eui.Image();
	...
	_proto.kImgPen1_i = function () {
		var t = new eui.Image();
		this.kImgPen1 = t;
		t.scaleX = 0.4;
		t.scaleY = 0.4;
		t.source = "img_lm_pencil_1_png";
		t.touchEnabled = false;
		t.x = 28;
		t.y = 40;
		return t;
	};
	_proto.kGrpPen2_i = function () {
		var t = new eui.Group();
		this.kGrpPen2 = t;
		t.touchChildren = false;
		t.touchEnabled = true;
		...
		t.x = 20;
		t.y = 20;
		t.elementsContent = [this._Image21_i(),this.kImgPen2_i()];
		return t;
	};
	_proto._Image21_i = function () {
		var t = new eui.Image();
	...
	_proto.kImgPen2_i = function () {
		var t = new eui.Image();
		this.kImgPen2 = t;
		t.scaleX = 0.4;
		t.scaleY = 0.4;
		t.source = "img_lm_pencil_2_png";
		t.touchEnabled = false;
		t.x = 28;
		t.y = 40;
		return t;
	};
	_proto.kGrpPen3_i = function () {
		var t = new eui.Group();
		this.kGrpPen3 = t;
		t.touchChildren = false;
		t.touchEnabled = true;
		...
		t.x = 30;
		t.y = 30;
		t.elementsContent = [this._Image22_i(),this.kImgPen3_i()];
		return t;
	};
	_proto._Image22_i = function () {
		var t = new eui.Image();
	...
	_proto.kImgPen3_i = function () {
		var t = new eui.Image();
		this.kImgPen3 = t;
		t.scaleX = 0.4;
		t.scaleY = 0.4;
		t.source = "img_lm_pencil_3_png";
		t.touchEnabled = false;
		t.x = 28;
		t.y = 40;
		return t;
	};
	_proto.kImgArrow2_i = function () {
		var t = new eui.Image();
		this.kImgArrow2 = t;
		t.anchorOffsetX = 25;
		t.anchorOffsetY = 100;
		t.scale9Grid = new egret.Rectangle(35,25,617,150);
		t.scaleY = 0.5;
		t.source = "img_lm_arr0_png";
		t.width = 150;
		t.x = 706;
		t.y = 294;
		return t;
	...
	_proto.kImgArrowStatic2_i = function () {
		var t = new eui.Image();
		this.kImgArrowStatic2 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 100;
		t.rotation = -64.5;
		t.scale9Grid = new egret.Rectangle(94,25,477,150);
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_lm_line0_png";
		t.width = 1607.23;
		t.x = 565.1;
		t.y = 902.96;
		return t;
	};
	_proto.kImgArrowStatic0_i = function () {
		var t = new eui.Image();
		this.kImgArrowStatic0 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 100;
		t.rotation = 64.5;
		t.scale9Grid = new egret.Rectangle(78,25,475,150);
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_lm_line0_png";
		t.width = 1605.84;
	...
	_proto.kImgArrowStatic1_i = function () {
		var t = new eui.Image();
		this.kImgArrowStatic1 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 100;
		t.scale9Grid = new egret.Rectangle(78,25,475,150);
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_lm_line1_png";
		t.width = 709.21;
		t.x = 563.15;
		t.y = 538;
		return t;
	};
	_proto.kImgPen_i = function () {
		var t = new eui.Image();
		this.kImgPen = t;
		t.anchorOffsetX = 23;
		t.anchorOffsetY = 208;
