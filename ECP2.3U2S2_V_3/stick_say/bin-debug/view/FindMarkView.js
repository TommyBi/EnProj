    ...
    var FindMarkView = (function (_super) {
        ...
        FindMarkView.prototype.createChildren = function () {
            ...
            for (var i = 0; i < 8; i++) {
                ...
                this["mAnimResult" + i].setProtery({ x: 0, y: 0, parent: this["kGrp" + i], scaleX: 4, scaleY: 4 });
        ...
        FindMarkView.prototype.onSelect = function (idx) {
            ...
            if (this.mIsSame[idx] == this.mCurState) {
                ...
                this.mCurState == 1 ? XDFSoundManager.play("sound_same_mp3") : XDFSoundManager.play("sound_dif_mp3");
                this["mAnimResult" + idx].visible = true;
                this.mPlayArr.push(idx);
                this["mAnimResult" + idx].play(null, 1, function () {
                    _this.isFinish();
                }, this);
            }
            else {
