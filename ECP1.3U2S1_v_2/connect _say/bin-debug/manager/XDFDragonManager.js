...
(function (XDFFrame) {
    var DBFactory = (function () {
        ...
        /** 创建骨骼动画 */
        DBFactory.createAnim = function (name, textureCount, isCreateMore) {
            if (textureCount === void 0) { textureCount = 1; }
            if (isCreateMore === void 0) { isCreateMore = false; }
            if (!this.cache[name] || isCreateMore) {
    ...
    var DBAnim = (function () {
        ...
        DBAnim.prototype.addEvent = function (callBack) {
            var _this = this;
            this.armatureDisplay.addEventListener(egret.TouchEvent.TOUCH_TAP, function () {
                if (callBack)
