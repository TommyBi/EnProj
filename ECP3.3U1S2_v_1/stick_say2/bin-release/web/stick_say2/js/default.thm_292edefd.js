...
})(eui.Skin);generateEUI.paths['resource/eui_skins/stick/StickSay2ViewSkin.exml'] = window.StickSay2ViewSkin = (function (_super) {
	__extends(StickSay2ViewSkin, _super);
	function StickSay2ViewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpAnim","kImgMask0","kImgMaskLine0","kImgMask1","kImgMaskLine1","kImgMask2","kImgMaskLine2","kImgOption0","kImgOption1","kImgOption2","kGrpDesc0","kGrpDesc1","kGrpDesc2","kComAnswer","kComReplay"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Rect1_i(),this.kGrpAnim_i(),this._Group2_i(),this._Rect2_i(),this.kGrpDesc0_i(),this.kGrpDesc1_i(),this.kGrpDesc2_i(),this.kComAnswer_i(),this.kComReplay_i()];
	}
	var _proto = StickSay2ViewSkin.prototype;
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 810;
		t.elementsContent = [this.kImgMask0_i(),this.kImgMaskLine0_i(),this.kImgMask1_i(),this.kImgMaskLine1_i(),this.kImgMask2_i(),this.kImgMaskLine2_i(),this._Group1_i()];
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.x = 41;
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this.kImgOption0_i(),this.kImgOption1_i(),this.kImgOption2_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
