	...
	function StickSayViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgMask0","kImgMaskLine0","kGrpAnim0","kGrpAnim1","kImgMask1","kImgMaskLine1","kImgMask2","kImgMaskLine2","kGrpAnim2","kImgDesc0","kImgDesc1","kImgDesc2","kGrpBtn0","kBtn1","kGrpBtn1","kBtn2","kGrpBtn2","kComReplay","kComAnswer","kComWordsPanel"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Group2_i(),this.kComReplay_i(),this.kComAnswer_i(),this.kComWordsPanel_i(),this._FlagCom1_i(),this._Image11_i()];
	}
