	...
	return DDSViewSkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/play/FindTheWayOutSkin.exml'] = window.FindTheWayOutSkin = (function (_super) {
	__extends(FindTheWayOutSkin, _super);
	function FindTheWayOutSkin() {
		_super.call(this);
		this.skinParts = ["kIcon0","kIcon1","kIcon2","kGrpFrame0","kGrpFrame1","kGrpFrame2","kGrpAnim","kComReplay","kComAnswer"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.kIcon0_i(),this.kIcon1_i(),this.kIcon2_i(),this.kGrpFrame0_i(),this.kGrpFrame1_i(),this.kGrpFrame2_i(),this.kGrpAnim_i(),this.kComReplay_i(),this.kComAnswer_i()];
	}
	var _proto = FindTheWayOutSkin.prototype;
	...
	_proto._Image2_i = function () {
		...
		t.height = 1099.58;
		t.horizontalCenter = 0;
		t.source = "img_f_bg_png";
		t.verticalCenter = 0;
		t.width = 1464.39;
		return t;
	};
	_proto.kIcon0_i = function () {
		var t = new eui.Image();
		this.kIcon0 = t;
		t.anchorOffsetX = 65;
		t.anchorOffsetY = 65;
		...
		t.scaleX = 1.4;
		t.scaleY = 1.4;
		t.source = "img_f_btn_0_png";
		t.y = 236.49;
		return t;
	};
	_proto.kIcon1_i = function () {
		var t = new eui.Image();
		this.kIcon1 = t;
		t.anchorOffsetX = 65;
		t.anchorOffsetY = 65;
		...
		t.scaleX = 1.4;
		t.scaleY = 1.4;
		t.source = "img_f_btn_1_png";
		t.y = 434.55;
		return t;
	};
	_proto.kIcon2_i = function () {
		var t = new eui.Image();
		this.kIcon2 = t;
		t.anchorOffsetX = 65;
		t.anchorOffsetY = 65;
		...
		t.scaleX = 1.4;
		t.scaleY = 1.4;
		t.source = "img_f_btn_2_png";
		t.y = 659.61;
		return t;
	};
	_proto.kGrpFrame0_i = function () {
		var t = new eui.Group();
		this.kGrpFrame0 = t;
		t.horizontalCenter = 0;
		t.y = 318.67;
	...
	function StickSayViewNewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpBtn0","kGrpBtn3","kGrpBtn2","kGrpBtn1","kGrpAnim","kImgMask0","kGrpMask0","kImgMask1","kGrpMask1","kImgMask2","kGrpMask2","kImgMask3","kGrpMask3","kComAnswer","kComReplay","kComWordsPanel"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Group1_i(),this.kGrpAnim_i(),this._FlagCom1_i(),this.kGrpMask0_i(),this.kGrpMask1_i(),this.kGrpMask2_i(),this.kGrpMask3_i(),this.kComAnswer_i(),this.kComReplay_i(),this.kComWordsPanel_i()];
	}
	...
	_proto._Group1_i = function () {
		...
		t.left = 20;
		t.layout = this._VerticalLayout1_i();
		t.elementsContent = [this.kGrpBtn0_i(),this.kGrpBtn3_i(),this.kGrpBtn2_i(),this.kGrpBtn1_i()];
		return t;
	};
	_proto._VerticalLayout1_i = function () {
		var t = new eui.VerticalLayout();
	...
	_proto.kGrpMask0_i = function () {
		...
		t.x = 1490;
		t.y = 610;
		t.elementsContent = [this._Image7_i(),this.kImgMask0_i()];
		return t;
	};
	_proto._Image7_i = function () {
		var t = new eui.Image();
		t.horizontalCenter = 0;
		t.source = "img_ss_mask_png";
		t.verticalCenter = 0;
		return t;
	};
	_proto.kImgMask0_i = function () {
		...
		this.kImgMask0 = t;
		t.horizontalCenter = 0;
		t.source = "img_ss_mask_line_png";
		t.verticalCenter = 0;
		return t;
	};
	_proto.kGrpMask1_i = function () {
		var t = new eui.Group();
		this.kGrpMask1 = t;
		t.scaleX = 0.45;
		t.scaleY = 0.5;
		t.x = 680;
		t.y = 590;
		t.elementsContent = [this._Image8_i(),this.kImgMask1_i()];
		return t;
	};
	_proto._Image8_i = function () {
		var t = new eui.Image();
	...
	_proto.kGrpMask2_i = function () {
		...
		t.x = 840;
		t.y = 110;
		t.elementsContent = [this._Image9_i(),this.kImgMask2_i()];
		return t;
	};
	...
	_proto.kGrpMask3_i = function () {
		...
		t.x = 1680;
		t.y = 140;
		t.elementsContent = [this._Image10_i(),this.kImgMask3_i()];
		return t;
	};
