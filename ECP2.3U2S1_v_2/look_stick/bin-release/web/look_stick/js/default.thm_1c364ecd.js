                ...
                generateEUI.skins = {"ItembkSkin":"resource/eui_skins/component/itembkSkin.exml","ItembkSkin1":"resource/eui_skins/component/itembkSkin1.exml","Box":"resource/eui_skins/component/Box.exml","game.StickSay":"resource/eui_skins/StickSay.exml","game.BtnSelect":"resource/eui_skins/BtnSelect.exml"};generateEUI.paths['resource/eui_skins/BtnSelect.exml'] = window.BtnSelectSkin = (function (_super) {
	...
	function StickSaySkin() {
		_super.call(this);
		this.skinParts = ["anim2","anim1","kAnimGp","kSide1","kHui1","kGp1","kHui2","kSide2","kGp2","kHui3","kSide3","kGp3","kTarget2","kTarget1","kTarget3","kAnswer3","kAnswer2","kAnswer1","kBtn","kGp","kGrpSmokeAnim","kReplay","kAnswer"];
		
		this.height = 1080;
		this.width = 1920;
		this.anim2_i();
		this.anim1_i();
		this.elementsContent = [this._Image1_i(),this.kGp_i(),this._Image6_i(),this.kGrpSmokeAnim_i(),this.kReplay_i(),this.kAnswer_i()];
	...
	_proto.kGp_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1440;
		t.elementsContent = [this._Image2_i(),this.kAnimGp_i(),this._Group4_i(),this.kBtn_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto._Group4_i = function () {
		...
		t.top = 0;
		t.width = 464;
		t.elementsContent = [this._Image3_i(),this.kGp1_i(),this.kGp2_i(),this.kGp3_i(),this._Image4_i(),this.kTarget2_i(),this.kTarget1_i(),this.kTarget3_i(),this._Image5_i(),this._Group1_i(),this._Group2_i(),this._Group3_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.scaleY = 1;
		t.y = 711.55;
		t.elementsContent = [this._Label1_i(),this.kAnswer3_i()];
		return t;
	};
	_proto._Label1_i = function () {
		var t = new eui.Label();
		...
		t.scaleY = 1;
		t.size = 36;
		t.text = "I’m good at skating.";
		t.textColor = 0x000000;
		t.verticalCenter = 0;
		t.x = -180;
		t.y = -421.0000000000001;
		return t;
	};
	...
	_proto._Group2_i = function () {
		...
		t.scaleY = 1;
		t.y = 455.28;
		t.elementsContent = [this._Label2_i(),this.kAnswer2_i()];
		return t;
	};
	_proto._Label2_i = function () {
		var t = new eui.Label();
		...
		t.scaleY = 1;
		t.size = 36;
		t.text = "I’m good at sledding.";
		t.textColor = 0x000000;
		t.verticalCenter = 0;
		t.x = -167;
		t.y = -202.26999999999998;
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.x = 69;
		t.y = 214.72;
		t.elementsContent = [this._Label3_i(),this.kAnswer1_i()];
		return t;
	};
	_proto._Label3_i = function () {
		var t = new eui.Label();
