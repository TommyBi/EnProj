	...
	function DDSViewSkin() {
		...
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Group1_i(),this._Image6_i(),this._Group3_i(),this._Group4_i(),this.kGrpAnimHummer_i(),this.kComRestart_i()];
	}
	...
	_proto._Group2_i = function () {
		...
		t.horizontalCenter = 0;
		t.top = -76;
		t.elementsContent = [this._Image7_i(),this.kLabelDesc_i()];
		return t;
	};
	...
	_proto.kLabelDesc_i = function () {
		...
		t.horizontalCenter = 0;
		t.size = 60;
		t.text = "Chickens give us eggs";
		t.textColor = 0x561721;
		t.verticalCenter = 58;
		return t;
	};
	_proto.kCom0_i = function () {
