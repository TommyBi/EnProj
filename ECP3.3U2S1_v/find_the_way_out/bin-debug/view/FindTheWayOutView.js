...
(function (game) {
    var FindTheWayOutView = (function (_super) {
        ...
        FindTheWayOutView.prototype.touchRight = function () {
            ...
            this.showAnim("run");
            egret.Tween.get(this.kGrpAnim).to({ x: this.mRightPos[this.mCurIdx].x, y: this.mRightPos[this.mCurIdx].y }, 1000).call(function () {
        ...
        FindTheWayOutView.prototype.touchErr = function () {
            ...
            this.showAnim("run");
            this.mLock_move = true;
            egret.Tween.get(this.kGrpAnim).to({ x: this.mErrPos[this.mCurIdx].x, y: this.mErrPos[this.mCurIdx].y }, 1000).call(function () {
