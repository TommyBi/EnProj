	...
	function LetsPlaySkin() {
		_super.call(this);
		this.skinParts = ["kGrpSheepIdle","kGrpSheepCatch","kGrpSheepJump","kGrpSheep","kImgHint","kImgOption0","kGrpOption0","kImgOption1","kGrpOption1","kImgBar","kGrpGame","kComRestart","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.x = 240;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this.kGrpSheep_i(),this.kImgHint_i(),this.kGrpOption0_i(),this.kGrpOption1_i(),this._Group1_i(),this.kGrpGame_i(),this.kComRestart_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
