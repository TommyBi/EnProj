	...
	function StickSayViewNewSkin() {
		_super.call(this);
		this.skinParts = ["kImgFrame0","kImgFrame1","kImgFrame2","kImgFrame3","kImgBodyBtn0","kImgBodyBtn1","kImgBodyBtn2","kImgBodyBtn3","kImgBody0","kImgBody1","kImgBody2","kImgBody3","kImgCoat0","kImgCoat1","kImgCoat2","kImgCoat3","kImgPanel","kComAnswer","kComReplay"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.kImgFrame0_i(),this.kImgFrame1_i(),this.kImgFrame2_i(),this.kImgFrame3_i(),this.kImgBodyBtn0_i(),this.kImgBodyBtn1_i(),this.kImgBodyBtn2_i(),this.kImgBodyBtn3_i(),this.kImgBody0_i(),this.kImgBody1_i(),this.kImgBody2_i(),this.kImgBody3_i(),this.kImgCoat0_i(),this.kImgCoat1_i(),this.kImgCoat2_i(),this.kImgCoat3_i(),this._Image3_i(),this._Image4_i(),this._Image5_i(),this._Image6_i(),this.kImgPanel_i(),this.kComAnswer_i(),this.kComReplay_i()];
	}
	...
	_proto.kImgBodyBtn0_i = function () {
		var t = new eui.Image();
		this.kImgBodyBtn0 = t;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_l_0_png";
		t.x = 203.39;
		t.y = 590.43;
		return t;
	};
	_proto.kImgBodyBtn1_i = function () {
		var t = new eui.Image();
		this.kImgBodyBtn1 = t;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_l_1_png";
		t.x = 370.67;
		t.y = 590.67;
		return t;
	};
	_proto.kImgBodyBtn2_i = function () {
		var t = new eui.Image();
		this.kImgBodyBtn2 = t;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_l_2_png";
		t.x = 584.5;
		t.y = 590.59;
		return t;
	};
	_proto.kImgBodyBtn3_i = function () {
		var t = new eui.Image();
		this.kImgBodyBtn3 = t;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_l_3_png";
		t.x = 769.24;
		t.y = 586;
		return t;
	};
	_proto.kImgBody0_i = function () {
		var t = new eui.Image();
		this.kImgBody0 = t;
		t.horizontalCenter = 358;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_b_0_png";
		t.y = 428;
		return t;
	};
	_proto.kImgBody1_i = function () {
		var t = new eui.Image();
		this.kImgBody1 = t;
		t.horizontalCenter = 356;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_b_1_png";
		t.y = 428;
		return t;
	};
	_proto.kImgBody2_i = function () {
		var t = new eui.Image();
		this.kImgBody2 = t;
		t.horizontalCenter = 346;
		t.scaleX = 0.48;
		t.scaleY = 0.48;
		t.source = "img_role_b_2_png";
		t.y = 446;
		return t;
	};
	_proto.kImgBody3_i = function () {
		var t = new eui.Image();
		this.kImgBody3 = t;
		t.horizontalCenter = 356;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_role_b_3_png";
		t.y = 428;
		return t;
	};
	_proto.kImgCoat0_i = function () {
		var t = new eui.Image();
		this.kImgCoat0 = t;
		t.scaleX = 0.7;
		t.scaleY = 0.7;
		t.source = "img_coat_0_png";
		t.x = 1168;
		t.y = 636;
		return t;
	};
	_proto.kImgCoat1_i = function () {
		var t = new eui.Image();
		this.kImgCoat1 = t;
		t.scaleX = 0.7;
		t.scaleY = 0.7;
		t.source = "img_coat_1_png";
		t.x = 1236;
		t.y = 904;
		return t;
	};
	_proto.kImgCoat2_i = function () {
		var t = new eui.Image();
		this.kImgCoat2 = t;
		t.scaleX = 0.7;
		t.scaleY = 0.7;
		t.source = "img_coat_2_png";
		t.x = 1202;
		t.y = 498;
		return t;
	};
	_proto.kImgCoat3_i = function () {
		var t = new eui.Image();
		this.kImgCoat3 = t;
		t.scaleX = 0.7;
		t.scaleY = 0.7;
		t.source = "img_coat_3_png";
		t.x = 1208;
		t.y = 972;
		return t;
	};
