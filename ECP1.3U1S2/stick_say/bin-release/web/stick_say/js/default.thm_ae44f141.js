	...
	function StickSayViewNewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpBtn0","kGrpBtn1","kGrpBtn2","kGrpBtn3","kImg0","kImgMask0","kImgMaskLine0","kImg1","kImgMask1","kImgMaskLine1","kImg2","kImgMask2","kImgMaskLine2","kImg3","kImgMask3","kImgMaskLine3","kGrpAnim","kComAnswer","kComReplay","kComWordsPanel"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Group1_i(),this.kImg0_i(),this.kImgMask0_i(),this.kImgMaskLine0_i(),this.kImg1_i(),this.kImgMask1_i(),this.kImgMaskLine1_i(),this.kImg2_i(),this.kImgMask2_i(),this.kImgMaskLine2_i(),this.kImg3_i(),this.kImgMask3_i(),this.kImgMaskLine3_i(),this.kGrpAnim_i(),this.kComAnswer_i(),this.kComReplay_i(),this.kComWordsPanel_i(),this._FlagCom1_i(),this._Image11_i()];
	}
