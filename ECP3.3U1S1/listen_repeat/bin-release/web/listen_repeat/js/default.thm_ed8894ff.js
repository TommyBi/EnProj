	...
	function ListenRepeatViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kComVideo","kCom0","kCom1","kCom2","kCom3","kCom4","kCom5","kCom6","kCom7","kImgBtnNext","kImgBtnPre"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.kImgBg_i(),this._Group3_i(),this.kImgBtnNext_i(),this.kImgBtnPre_i()];
	}
