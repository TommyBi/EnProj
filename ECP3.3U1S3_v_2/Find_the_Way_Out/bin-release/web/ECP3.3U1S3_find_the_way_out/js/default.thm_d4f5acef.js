...
})(eui.Skin);generateEUI.paths['resource/eui_skins/find/FindWay.exml'] = window.FindWaySkin = (function (_super) {
	__extends(FindWaySkin, _super);
	function FindWaySkin() {
		_super.call(this);
		this.skinParts = ["kImg1","kImg2","kImg3","kItem1","kItem2","kItem3","kItem4","kItem5","kItem6","kItemGp","kAnimGp","kAnswer","kReplay"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Group2_i(),this.kAnswer_i(),this.kReplay_i()];
	}
	var _proto = FindWaySkin.prototype;
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1440;
		t.elementsContent = [this._Image2_i(),this.kImg1_i(),this.kImg2_i(),this.kImg3_i(),this.kItemGp_i(),this.kAnimGp_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.kItemGp_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.kItem1_i(),this.kItem2_i(),this.kItem3_i(),this.kItem4_i(),this.kItem5_i(),this.kItem6_i()];
		return t;
	};
	_proto.kItem1_i = function () {
		var t = new game.FindWayItem();
		this.kItem1 = t;
		t.anchorOffsetX = 0;
		t.anchorOffsetY = 0;
		t.currentState = "1";
		t.touchEnabled = true;
		t.x = 382.71000000000004;
		t.y = 295.81;
		return t;
	};
	_proto.kItem2_i = function () {
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/FindWayItem.exml'] = window.FindWayItemSkin = (function (_super) {
	__extends(FindWayItemSkin, _super);
	function FindWayItemSkin() {
		_super.call(this);
		this.skinParts = ["kLb","kSide"];
		...
		this.states = [
			...
			new eui.State ("2",
				[
					new eui.SetProperty("_Image1","source","find_2_png"),
					new eui.SetProperty("_Image1","width",250),
					new eui.SetProperty("kLb","text","She is Vietnamese."),
					new eui.SetProperty("kSide","source","side_2_png"),
					new eui.SetProperty("kSide","anchorOffsetX",130),
					new eui.SetProperty("kSide","width",260)
				])
			,
			new eui.State ("3",
				[
					new eui.SetProperty("_Image1","source","find_5_png"),
					new eui.SetProperty("_Image1","width",250),
					new eui.SetProperty("_Image1","height",70),
					new eui.SetProperty("kLb","text",""),
					new eui.SetProperty("kLb","width",320),
					new eui.SetProperty("kLb","horizontalCenter",3.5),
					new eui.SetProperty("kLb","verticalCenter",6),
					new eui.SetProperty("kSide","source","side_3_png")
				])
		];
	}
	var _proto = FindWayItemSkin.prototype;
	...
	_proto._Group1_i = function () {
		...
		t.top = 0;
		t.touchEnabled = true;
		t.elementsContent = [this._Image1_i(),this.kLb_i(),this.kSide_i()];
		return t;
	};
	_proto._Image1_i = function () {
		var t = new eui.Image();
