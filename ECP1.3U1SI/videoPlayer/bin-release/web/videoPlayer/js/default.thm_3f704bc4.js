	...
	function CaptionPlayerComSkin() {
		_super.call(this);
		this.skinParts = ["kGrpVideo","kComPro","kImgShowCaption","kImgRePlay","kImgPause","kImgPlay","kGrpControl"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this.kGrpVideo_i(),this.kComPro_i(),this.kGrpControl_i()];
	}
	...
	_proto.kGrpControl_i = function () {
		...
		t.x = 1248;
		t.y = 974;
		t.elementsContent = [this.kImgShowCaption_i(),this.kImgRePlay_i(),this.kImgPause_i(),this.kImgPlay_i()];
		return t;
	};
	_proto.kImgShowCaption_i = function () {
		var t = new eui.Image();
		this.kImgShowCaption = t;
		t.scaleX = 0.5;
		t.scaleY = 0.5;
		t.source = "img_pro_icon_png";
		t.x = 0;
