	...
	return MainViewSkin;
})(eui.Skin);generateEUI.paths['resource/eui_skins/play/FollowSayViewSkin.exml'] = window.FollowSayViewSkin = (function (_super) {
	__extends(FollowSayViewSkin, _super);
	function FollowSayViewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpAnimLine","kImgFrameLine0","kLabel0","kGrpRoleAnim0","kGrpRoleAnim1","kImgFrameLine1","kLabel1","kGrpRoleAnim2","kGrpRoleAnim3","kImgWordsBg0","kLabelDesc0","kGrpOption0","kImgWordsBg1","kLabelDesc1","kGrpOption1","kImgWordsBg2","kLabelDesc2","kGrpOption2","kImgWordsBg3","kLabelDesc3","kGrpOption3","kComAnswer","kComReplay"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Rect1_i(),this._Image2_i(),this.kGrpAnimLine_i(),this._Group1_i(),this._Group2_i(),this.kGrpOption0_i(),this.kGrpOption1_i(),this.kGrpOption2_i(),this.kGrpOption3_i(),this.kComAnswer_i(),this.kComReplay_i()];
	}
	var _proto = FollowSayViewSkin.prototype;
	...
	_proto._Image2_i = function () {
		...
		t.scaleX = 0.3;
		t.scaleY = 0.3;
		t.source = "img_fs_bg1_png";
		t.verticalCenter = 109.5;
		t.width = 3486.67;
		return t;
	};
	_proto.kGrpAnimLine_i = function () {
		var t = new eui.Group();
		this.kGrpAnimLine = t;
		t.bottom = 0;
		t.left = 0;
	...
	_proto._Group1_i = function () {
		...
		t.top = 14;
		t.x = 300;
		t.elementsContent = [this._Image3_i(),this.kImgFrameLine0_i(),this._Label1_i(),this.kLabel0_i(),this.kGrpRoleAnim0_i(),this.kGrpRoleAnim1_i(),this._Image4_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
		t.height = 334;
		t.source = "img_fs_bg3_png";
		t.width = 643;
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.kImgFrameLine0_i = function () {
		var t = new eui.Image();
		this.kImgFrameLine0 = t;
		t.scaleX = 0.5;
		t.scaleY = 0.4;
		t.source = "img_fs_frame_line_yellow_png";
		t.x = 10;
		t.y = 20;
		return t;
	};
	...
	_proto.kLabel0_i = function () {
		var t = new eui.Label();
		this.kLabel0 = t;
		t.horizontalCenter = 121.5;
		t.size = 50;
		t.text = "swimming";
		t.textColor = 0x155dbe;
		t.y = 33;
		return t;
	};
	_proto.kGrpRoleAnim0_i = function () {
		var t = new eui.Group();
		this.kGrpRoleAnim0 = t;
		t.height = 204;
		t.width = 258;
		t.x = 30;
		t.y = 110;
	...
	_proto.kGrpRoleAnim1_i = function () {
		var t = new eui.Group();
		this.kGrpRoleAnim1 = t;
		t.height = 204;
		t.width = 258;
		t.x = 355;
		t.y = 110;
	...
	_proto._Group2_i = function () {
		...
		t.top = 14;
		t.x = 960;
		t.elementsContent = [this._Image5_i(),this.kImgFrameLine1_i(),this.kLabel1_i(),this._Label2_i(),this.kGrpRoleAnim2_i(),this.kGrpRoleAnim3_i(),this._Image6_i()];
		return t;
	};
	_proto._Image5_i = function () {
		var t = new eui.Image();
		...
		t.scaleX = 1;
		t.scaleY = 1;
		t.source = "img_fs_bg2_png";
		t.width = 643;
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.kImgFrameLine1_i = function () {
		var t = new eui.Image();
		this.kImgFrameLine1 = t;
		t.scaleX = 0.5;
		t.scaleY = 0.4;
		t.source = "img_fs_frame_line_purple_png";
		t.x = 12;
		t.y = 18;
		return t;
	};
	_proto.kLabel1_i = function () {
		var t = new eui.Label();
		this.kLabel1 = t;
	...
	_proto._Label2_i = function () {
		var t = new eui.Label();
		t.size = 40;
		t.text = "My house is made of";
		t.textColor = 0x000000;
		t.x = 28.2;
		t.y = 36;
		return t;
	};
	_proto.kGrpRoleAnim2_i = function () {
		var t = new eui.Group();
		this.kGrpRoleAnim2 = t;
		t.height = 204;
		t.scaleX = 1;
		t.scaleY = 1;
		t.width = 258;
	...
	_proto.kGrpRoleAnim3_i = function () {
		var t = new eui.Group();
		this.kGrpRoleAnim3 = t;
		t.height = 204;
		t.scaleX = 1;
		t.scaleY = 1;
		t.width = 258;
	...
	_proto.kGrpOption0_i = function () {
		...
		t.x = 1114;
		t.y = 1011;
		t.elementsContent = [this.kImgWordsBg0_i(),this.kLabelDesc0_i()];
		return t;
	};
	_proto.kImgWordsBg0_i = function () {
		var t = new eui.Image();
		this.kImgWordsBg0 = t;
		t.scaleX = 0.35;
		t.scaleY = 0.3;
		t.source = "img_fs_bg4_png";
		t.touchEnabled = false;
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.kLabelDesc0_i = function () {
		var t = new eui.Label();
		this.kLabelDesc0 = t;
		t.horizontalCenter = 0;
		t.size = 40;
	...
	_proto.kGrpOption1_i = function () {
		...
		t.x = 508;
		t.y = 1011;
		t.elementsContent = [this.kImgWordsBg1_i(),this.kLabelDesc1_i()];
		return t;
	};
	_proto.kImgWordsBg1_i = function () {
		var t = new eui.Image();
		this.kImgWordsBg1 = t;
		t.scaleX = 0.35;
		t.scaleY = 0.3;
	...
	_proto.kGrpOption2_i = function () {
		...
		t.x = 803;
		t.y = 1011;
		t.elementsContent = [this.kImgWordsBg2_i(),this.kLabelDesc2_i()];
		return t;
	};
	_proto.kImgWordsBg2_i = function () {
		var t = new eui.Image();
		this.kImgWordsBg2 = t;
		t.scaleX = 0.35;
		t.scaleY = 0.3;
	...
	_proto.kGrpOption3_i = function () {
		...
		t.x = 1407;
		t.y = 1011;
		t.elementsContent = [this.kImgWordsBg3_i(),this.kLabelDesc3_i()];
		return t;
	};
	_proto.kImgWordsBg3_i = function () {
		var t = new eui.Image();
		this.kImgWordsBg3 = t;
		t.scaleX = 0.35;
		t.scaleY = 0.3;
	...
	_proto.kGrpTar1_i = function () {
		...
		t.x = 1156.18;
		t.y = 54.54;
		t.elementsContent = [this._Image8_i(),this.kImgMask1_i(),this.kImgMaskLine1_i(),this.kImgDesc1_i()];
		return t;
	};
	_proto._Image8_i = function () {
		var t = new eui.Image();
	...
	_proto.kGrpTar2_i = function () {
		...
		t.x = 370.51;
		t.y = 75.53;
		t.elementsContent = [this._Image9_i(),this.kImgMaskLine2_i(),this.kImgMask2_i(),this.kImgDesc2_i()];
		return t;
	};
	_proto._Image9_i = function () {
		var t = new eui.Image();
	...
	_proto.kGrpTar3_i = function () {
		...
		t.x = 324.27;
		t.y = 510.03;
		t.elementsContent = [this._Image10_i(),this.kImgMask3_i(),this.kImgMaskLine3_i(),this.kImgDesc3_i()];
		return t;
	};
	_proto._Image10_i = function () {
		var t = new eui.Image();
	...
	_proto.kGrpTar0_i = function () {
		...
		t.x = 1179.63;
		t.y = 547.11;
		t.elementsContent = [this._Image11_i(),this.kImgMask0_i(),this.kImgMaskLine0_i(),this.kImgDesc0_i()];
		return t;
	};
	_proto._Image11_i = function () {
		var t = new eui.Image();
