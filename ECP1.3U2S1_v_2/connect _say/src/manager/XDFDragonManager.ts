namespace XDFFrame {
    export class DBFactory {
        ...
        /** 创建骨骼动画 */
        public static createAnim(name: string, textureCount: number = 1, isCreateMore = false): DBAnim {
    ...
    export class DBAnim {
        ...
        addEvent(callBack) {
            this.armatureDisplay.addEventListener(egret.TouchEvent.TOUCH_TAP, () => {
        ...
        public gotoAndStopByFrame(armatureName: string = null, frame: number = 0, cb?: Function, thisObj?: any): void {
