...
(function (game) {
    var DDSView = (function (_super) {
        ...
        DDSView.prototype.createChildren = function () {
            ...
            this.mAnimHammerErr.setProtery({ x: 0, y: 0, parent: this.kGrpAnimHummer, scaleX: 0.45, scaleY: 0.45 });
            this.mAnimHammerRight = XDFFrame.DBFactory.createAnim("db_hammer_right");
            this.mAnimHammerRight.setProtery({ x: 0, y: 0, parent: this.kGrpAnimHummer, scaleX: 0.8, scaleY: 0.8 });
