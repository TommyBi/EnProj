	...
	function ListenRepeatViewSkin() {
		_super.call(this);
		this.skinParts = ["kComVideo","kCom0","kCom1","kCom2","kCom3","kCom4","kCom5","kCom6","kCom7","kGrpDialog","kImgBtnNext","kImgBtnPre"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Group2_i(),this.kImgBtnNext_i(),this.kImgBtnPre_i()];
	}
	...
	_proto._Group2_i = function () {
		...
		t.elementsContent = [this._Group1_i(),this.kGrpDialog_i()];
		return t;
	};
