	...
	function StickSay1ViewSkin() {
		_super.call(this);
		this.skinParts = ["kGrpAnim","kImgMaskLineBig0","kGrpDesc0","kImgMask0","kImgMaskLine0","kImgMaskLineBig1","kGrpDesc1","kImgMask1","kImgMaskLine1","kImgMaskLineBig2","kGrpDesc2","kImgMask2","kImgMaskLine2","kComAnswer","kComReplay","kGrpOption2","kGrpOption0","kGrpOption1","kComWordsPanel"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this.kGrpAnim_i(),this._Group3_i(),this._Group6_i(),this._Group9_i(),this.kComAnswer_i(),this.kComReplay_i(),this._Group10_i(),this.kComWordsPanel_i(),this._FlagCom1_i(),this._Image9_i()];
	}
	...
	_proto._Group1_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image3_i(),this.kImgMaskLineBig0_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
	...
	_proto.kImgMaskLineBig0_i = function () {
		...
		t.source = "img_ss_mask_line_big0_png";
	...
	_proto._Group6_i = function () {
		...
		t.x = 989.12;
		t.y = 46.43;
		t.elementsContent = [this._Group4_i(),this.kGrpDesc1_i(),this._Group5_i()];
		return t;
	};
	_proto._Group4_i = function () {
		var t = new eui.Group();
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this._Image4_i(),this.kImgMaskLineBig1_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
	...
	_proto._Group9_i = function () {
		...
		t.x = 307.2;
		t.y = 667.27;
		t.elementsContent = [this._Group7_i(),this.kGrpDesc2_i(),this._Group8_i()];
		return t;
	};
	...
	_proto._Group10_i = function () {
		...
		t.scaleY = 0.8;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this.kGrpOption2_i(),this.kGrpOption0_i(),this.kGrpOption1_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
