	...
	function ThinkComponentSkin() {
		_super.call(this);
		this.skinParts = ["kImgShadow","kImgCard","kGrpBg","kImgNameBg","kImgArrow","kLabelWord","kGrpWord","kImgMask","kImgNameBg0","kImgArrow0","kGrpWordStatic","kImgSound","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.width = 469;
		t.y = 0;
		t.elementsContent = [this.kGrpBg_i(),this.kGrpWord_i(),this.kImgMask_i(),this.kGrpWordStatic_i(),this.kImgSound_i()];
		return t;
	};
	_proto.kGrpBg_i = function () {
		var t = new eui.Group();
