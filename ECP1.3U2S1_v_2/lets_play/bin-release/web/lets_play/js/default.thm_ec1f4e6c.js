	...
	function LetsPlaySkin() {
		_super.call(this);
		this.skinParts = ["kAnswer2","kAnswer1","kIcon2","kIcon1","kAnim","kComRestart","kComBar","kGp"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this.kGp_i()];
	}
	...
	_proto.kGp_i = function () {
		...
		t.x = 240;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this.kAnswer2_i(),this.kAnswer1_i(),this.kIcon2_i(),this.kIcon1_i(),this._Image3_i(),this._Image4_i(),this.kAnim_i(),this._Image5_i(),this._Image6_i(),this.kComRestart_i(),this.kComBar_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
