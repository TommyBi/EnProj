	...
	function StickSaySkin() {
		_super.call(this);
		this.skinParts = ["anim2","anim1","kAnimGp","kSide1","kHui1","kGp1","kHui2","kSide2","kGp2","kHui3","kSide3","kGp3","kAnswer3","kAnswer2","kAnswer1","kBtn","kGp","kComWordsPanel","kGrpSmokeAnim","kReplay","kAnswer"];
	...
	_proto.kGp_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1440;
		t.elementsContent = [this._Image2_i(),this.kAnimGp_i(),this.kGp1_i(),this.kGp2_i(),this.kGp3_i(),this.kAnswer3_i(),this.kAnswer2_i(),this.kAnswer1_i(),this.kBtn_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.kAnswer2_i = function () {
		var t = new eui.Group();
		this.kAnswer2 = t;
		t.anchorOffsetX = 156.06;
		t.anchorOffsetY = 9.09;
		t.visible = false;
		t.x = 803.73;
		t.y = 732.36;
	...
	_proto.kAnswer1_i = function () {
		var t = new eui.Group();
		this.kAnswer1 = t;
		t.anchorOffsetX = 53.03;
		t.anchorOffsetY = 119.7;
		t.visible = false;
		t.x = 194.73;
		t.y = 548.42;
