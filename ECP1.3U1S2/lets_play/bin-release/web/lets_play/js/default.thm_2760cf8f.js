	...
	function LetsPlaySkin() {
		_super.call(this);
		this.skinParts = ["kImgOption0","klbl_m_0","kLbl_b_0","kGrp_b_0","kImgOption1","klbl_m_1","kLbl_b_1","kGrp_b_1","kImgOption2","klbl_m_2","kLbl_b_2","kGrp_b_2","kImgOption3","klbl_m_3","kLbl_b_3","kGrp_b_3","kComTimeBar","kComRestart"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Group9_i(),this.kComTimeBar_i(),this.kComRestart_i()];
	}
	...
	_proto._Group2_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.kImgOption0_i(),this._Group1_i(),this.kGrp_b_0_i()];
		return t;
	};
	...
	_proto._Group1_i = function () {
		...
		t.horizontalCenter = 0;
		t.y = 255;
		t.elementsContent = [this._Image3_i(),this.klbl_m_0_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
		t.scaleX = 1.2;
		t.scaleY = 1.2;
		t.source = "img_p_frame_0_png";
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.klbl_m_0_i = function () {
		var t = new eui.Label();
		this.klbl_m_0 = t;
		t.bold = true;
		...
		t.size = 45;
		t.text = "sneakers";
		t.textColor = 0x5b3a1b;
		t.verticalCenter = 0;
		return t;
	};
	_proto.kGrp_b_0_i = function () {
		var t = new eui.Group();
		this.kGrp_b_0 = t;
		t.anchorOffsetX = 121;
		t.anchorOffsetY = 61;
		...
		t.y = 560;
		t.elementsContent = [this._Image4_i(),this.kLbl_b_0_i()];
		return t;
	};
	_proto._Image4_i = function () {
		var t = new eui.Image();
		t.scaleX = 1.2;
		t.scaleY = 1.2;
		t.source = "img_p_frame_1_png";
		t.x = 0;
		t.y = 0;
		return t;
	};
	_proto.kLbl_b_0_i = function () {
		var t = new eui.Label();
		this.kLbl_b_0 = t;
		t.bold = true;
		t.horizontalCenter = 0;
	...
	_proto._Group4_i = function () {
		...
		t.x = 10;
		t.y = 10;
		t.elementsContent = [this.kImgOption1_i(),this._Group3_i(),this.kGrp_b_1_i()];
		return t;
	};
	...
	_proto._Group3_i = function () {
		...
		t.horizontalCenter = 0;
		t.y = 255;
		t.elementsContent = [this._Image5_i(),this.klbl_m_1_i()];
		return t;
	};
	_proto._Image5_i = function () {
		var t = new eui.Image();
	...
	_proto.kGrp_b_1_i = function () {
		...
		t.touchThrough = false;
		t.y = 560;
		t.elementsContent = [this._Image6_i(),this.kLbl_b_1_i()];
		return t;
	};
	...
	_proto._Group6_i = function () {
		...
		t.x = 20;
		t.y = 20;
		t.elementsContent = [this.kImgOption2_i(),this._Group5_i(),this.kGrp_b_2_i()];
		return t;
	};
	...
	_proto._Group5_i = function () {
		...
		t.horizontalCenter = 0;
		t.y = 255;
		t.elementsContent = [this._Image7_i(),this.klbl_m_2_i()];
		return t;
	};
	...
	_proto.kGrp_b_2_i = function () {
		...
		t.touchThrough = false;
		t.y = 560;
		t.elementsContent = [this._Image8_i(),this.kLbl_b_2_i()];
		return t;
	};
	...
	_proto._Group8_i = function () {
		...
		t.x = 30;
		t.y = 30;
		t.elementsContent = [this.kImgOption3_i(),this._Group7_i(),this.kGrp_b_3_i()];
		return t;
	};
	...
	_proto._Group7_i = function () {
		...
		t.horizontalCenter = 0;
		t.y = 255;
		t.elementsContent = [this._Image9_i(),this.klbl_m_3_i()];
		return t;
	};
	...
	_proto.kGrp_b_3_i = function () {
		...
		t.touchThrough = false;
		t.y = 560;
		t.elementsContent = [this._Image10_i(),this.kLbl_b_3_i()];
		return t;
	};
