    ...
    var WordsPanelCom = (function (_super) {
        ...
        WordsPanelCom.prototype.hide = function (cb) {
            ...
            if (this.kGrpMain.x > 0) {
                // 收
                this.kGrpMain.x = 0;
                egret.Tween.get(this.kGrpMain).to({ x: -310 }, 800, egret.Ease.cubicInOut).call(function () {
                    _this.mIsMoving = false;
                    if (cb)
                        cb();
                });
        ...
        WordsPanelCom.prototype.playAction = function (cb) {
            ...
            if (this.kGrpMain.x > 0) {
                ...
                // 展开
                this.kGrpMain.x = -310;
                egret.Tween.get(this.kGrpMain).to({ x: 3 }, 800, egret.Ease.cubicInOut).call(function () {
                    _this.mIsMoving = false;
                    cb && cb();
                });
            }
