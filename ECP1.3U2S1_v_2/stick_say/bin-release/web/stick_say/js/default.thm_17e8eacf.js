	...
	function StickSaySkin() {
		_super.call(this);
		this.skinParts = ["anim2","anim1","kImg3","kAnim","kHui1","kSide1","kGp1","kHui2","kSide2","kGp2","kHui3","kSide3","kGp3","kAnswer2","kAnswer3","kAnswer1","kBtn","kGp","kComWordsPanel","kGrpSmokeAnim","kReplay","kAnswer"];
	...
	_proto.kGp_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1440;
		t.elementsContent = [this._Image2_i(),this.kImg3_i(),this.kAnim_i(),this.kGp1_i(),this.kGp2_i(),this.kGp3_i(),this.kAnswer2_i(),this.kAnswer3_i(),this.kAnswer1_i(),this.kBtn_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto.kGp1_i = function () {
		...
		t.x = 200;
		t.y = 560;
		t.elementsContent = [this.kHui1_i(),this.kSide1_i()];
		return t;
	};
	...
	_proto.kAnswer3_i = function () {
		var t = new eui.Group();
		this.kAnswer3 = t;
		t.anchorOffsetX = 258.72;
		t.anchorOffsetY = 1.64;
		t.visible = false;
		t.x = 1120.51;
		t.y = 347.76;
	...
	_proto.kAnswer1_i = function () {
		var t = new eui.Group();
		this.kAnswer1 = t;
		t.anchorOffsetX = 298.24;
		t.anchorOffsetY = -2.84;
		t.visible = false;
		t.x = 330.01;
		t.y = 767.52;
