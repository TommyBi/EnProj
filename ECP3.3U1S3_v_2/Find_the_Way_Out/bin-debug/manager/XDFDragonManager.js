...
(function (XDFFrame) {
    var DBFactory = (function () {
        ...
        /** 创建骨骼动画 */
        DBFactory.createAnim = function (name, textureCount, isCache) {
            if (textureCount === void 0) { textureCount = 1; }
            if (isCache === void 0) { isCache = true; }
            if (!this.cache[name] || !isCache) {
    ...
    var DBAnim = (function () {
        ...
        DBAnim.prototype.setPoint = function (cfg) {
            this.armatureDisplay.x = cfg.x || 0;
            this.armatureDisplay.y = cfg.y || 0;
        };
        DBAnim.prototype.getPoint = function () {
            return { x: this.armatureDisplay.x, y: this.armatureDisplay.y };
        };
        /**
         * 播放
