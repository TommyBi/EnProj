	...
	function LetsPlaySkin() {
		_super.call(this);
		this.skinParts = ["kBird1","kBird2","kItem1","kItem2","kItem3","kImg1","kImg2","kImg3","kAnimGp","kGp","kRestart","kTimeBar"];
	...
	_proto.kGp_i = function () {
		...
		t.x = 240;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this._Image3_i(),this._Image4_i(),this._Group1_i(),this._Group2_i(),this.kItem1_i(),this.kItem2_i(),this.kItem3_i(),this.kImg1_i(),this.kImg2_i(),this.kImg3_i(),this.kAnimGp_i(),this._Image7_i(),this._Image8_i(),this._Image9_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
	...
	_proto._Group1_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1920;
		t.elementsContent = [this.kBird1_i(),this.kBird2_i(),this._Image5_i(),this._Image6_i()];
		return t;
	};
	_proto.kBird1_i = function () {
		var t = new eui.Image();
		this.kBird1 = t;
		t.scaleX = 1.3;
		t.scaleY = 1.3;
	...
	function PlayItemSkin() {
		...
		this.height = 400;
		this.width = 400;
		this.elementsContent = [this._Image1_i(),this.kImg_i()];
	}
