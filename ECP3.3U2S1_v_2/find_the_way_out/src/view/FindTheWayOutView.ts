namespace game {
    export class FindTheWayOutView extends eui.Component {
        ...
        private onStart(): void {
            ...
            egret.Tween.get(this.kGrpAnim).to({ x: 1200, y: 290 }, 1500, egret.Ease.cubicInOut).call(() => { this.kGrpAnim.scaleX = -1 });
        ...
        private touchRight(): void {
            ...
            this.showAnim("run");
            egret.Tween.get(this.kGrpAnim).to({ x: this.mRightPos[this.mCurIdx].x, y: this.mRightPos[this.mCurIdx].y }, 1500).call(() => {
        ...
        private touchErr(): void {
            ...
            this.showAnim("run");
            this.mLock_move = true;
            egret.Tween.get(this.kGrpAnim).to({ x: this.mErrPos[this.mCurIdx].x, y: this.mErrPos[this.mCurIdx].y }, 1500).call(() => {
