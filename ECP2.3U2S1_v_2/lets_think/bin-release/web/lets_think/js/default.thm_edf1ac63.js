...
})(eui.Skin);generateEUI.paths['resource/eui_skins/LetsSingViewSkin.exml'] = window.LetsSingViewSkin = (function (_super) {
...
})(eui.Skin);generateEUI.paths['resource/eui_skins/think/ThinkComPictureBookSkin.exml'] = window.ThinkComPictureBookSkin = (function (_super) {
	__extends(ThinkComPictureBookSkin, _super);
	function ThinkComPictureBookSkin() {
		_super.call(this);
		this.skinParts = ["kImgShadow","kImgCard","kGrpBg","kGrpMain"];
		
		this.height = 666;
		this.elementsContent = [this.kGrpMain_i()];
	}
	var _proto = ThinkComPictureBookSkin.prototype;
	...
	_proto.kGrpMain_i = function () {
		...
		t.width = 469;
		t.y = 0;
		t.elementsContent = [this.kGrpBg_i()];
		return t;
	};
	...
	return ThinkComPictureBookSkin;
	...
	function ThinkComponentSkin() {
		_super.call(this);
		this.skinParts = ["kImgShadow","kImgCard","kGrpBg","kImgNameBg","kImgArrow","kLabelWord","kGrpWord","kMask","kImgNameBg0","kImgArrow0","kGrpWordStatic","kImgSound","kGrpMain"];
		
		this.height = 666;
		this.elementsContent = [this.kGrpMain_i()];
		
		eui.Binding.$bindProperties(this, ["kMask"],[0],this.kGrpWord,"mask");
	}
	...
	_proto.kGrpMain_i = function () {
		...
		t.width = 469;
		t.y = 0;
		t.elementsContent = [this.kGrpBg_i(),this.kGrpWord_i(),this.kMask_i(),this.kGrpWordStatic_i(),this.kImgSound_i()];
		return t;
	};
	_proto.kGrpBg_i = function () {
		var t = new eui.Group();
