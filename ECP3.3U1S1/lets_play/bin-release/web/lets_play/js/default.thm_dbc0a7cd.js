	...
	function LetsPlaySkin() {
		_super.call(this);
		this.skinParts = ["kGrpSheepIdle","kGrpSheepCatch","kGrpSheepJump","kGrpSheep","kImgMask","kImgHint","kImgOption0","kGrpOption0","kImgOption1","kGrpOption1","kImgOption2","kGrpOption2","kImgOption3","kGrpOption3","kGrpOption","kGrpGame","kComRestart","kLabelHint","kComBar","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.x = 240;
		t.y = 0;
		t.elementsContent = [this._Image2_i(),this.kGrpSheep_i(),this.kImgMask_i(),this.kImgHint_i(),this.kGrpOption_i(),this.kGrpGame_i(),this.kComRestart_i(),this.kLabelHint_i(),this.kComBar_i()];
		return t;
	};
	_proto._Image2_i = function () {
		var t = new eui.Image();
