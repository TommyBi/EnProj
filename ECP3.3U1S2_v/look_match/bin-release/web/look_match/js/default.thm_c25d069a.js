	...
	function LookMatchViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgMask0","kGrpStart0","kImgMask1","kGrpStart1","kImgMask2","kGrpStart2","kGrpTar0","kGrpTar2","kGrpTar1","kImgPen0","kGrpPen0","kImgPen1","kGrpPen1","kImgPen2","kGrpPen2","kImgPen3","kGrpPen3","kImgArrow2","kImgArrow0","kImgArrow1","kImgArrowStatic2","kImgArrowStatic1","kImgArrowStatic0","kImgPen","kComReplay","kComAnswer"];
		
		this.height = 1080;
		this.width = 1920;
		this.elementsContent = [this._Image1_i(),this._Image2_i(),this._Group1_i(),this.kGrpStart0_i(),this._Group2_i(),this.kGrpStart1_i(),this._Group3_i(),this.kGrpStart2_i(),this.kGrpTar0_i(),this._Group4_i(),this.kGrpTar2_i(),this._Group5_i(),this.kGrpTar1_i(),this._Group6_i(),this._Image18_i(),this._Group7_i(),this.kImgArrow2_i(),this.kImgArrow0_i(),this.kImgArrow1_i(),this.kImgArrowStatic2_i(),this.kImgArrowStatic1_i(),this.kImgArrowStatic0_i(),this.kImgPen_i(),this.kComReplay_i(),this.kComAnswer_i()];
	}
	...
	_proto._Group1_i = function () {
		...
		t.x = 182;
		t.y = 28;
		t.elementsContent = [this._Image3_i(),this._Image4_i(),this.kImgMask0_i()];
		return t;
	};
	_proto._Image3_i = function () {
		var t = new eui.Image();
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0;
		t.x = 182;
		t.elementsContent = [this._Image6_i(),this._Image7_i(),this.kImgMask1_i()];
		return t;
	};
	_proto._Image6_i = function () {
		var t = new eui.Image();
	...
	_proto._Group3_i = function () {
		...
		t.x = 182;
		t.elementsContent = [this._Image9_i(),this._Image10_i(),this.kImgMask2_i()];
		return t;
	};
	_proto._Image9_i = function () {
		var t = new eui.Image();
	...
	_proto._Label1_i = function () {
		...
		t.horizontalCenter = 0;
		t.size = 38;
		t.text = "Kids in costumes get lots of candy";
		t.textColor = 0x000000;
		t.verticalCenter = 0;
		t.width = 400;
		return t;
	...
	_proto._Group5_i = function () {
		...
		t.verticalCenter = 0.5;
		t.x = 980;
		t.elementsContent = [this._Image15_i(),this._Label2_i()];
		return t;
	};
	_proto._Image15_i = function () {
		var t = new eui.Image();
	...
	_proto._Label3_i = function () {
		...
		t.horizontalCenter = 0;
		t.size = 38;
		t.text = "People throw tomatoes at each other.";
		t.textColor = 0x000000;
		t.verticalCenter = 0;
		t.width = 420;
		return t;
